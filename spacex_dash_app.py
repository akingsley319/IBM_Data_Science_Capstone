...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        data = filtered_df[filtered_df['class']==1].groupby('Launch Site')['Launch Site'].count()
...
def get_scatter_chart(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        data = filtered_df[filtered_df['Launch Site']==entered_site][['Launch Site', 'class', 'Payload Mass (kg)', 'Booster Version Category']]
        fig = px.scatter(data, x="Payload Mass (kg)", y="class",
                        color="Booster Version Category",
